...
router.get('/:id', function(req, res) {
	...
	const id_e_group = parseInt(req.params.id);
...
router.get('/:id/:association', function(req, res) {
	...
	const id_e_group = req.params.id;
...
router.post('/', function(req, res) {
	...
	models.E_group.create(createObject, {user: req.user}).then(function(e_group) {
		answer["e_group".substring(2)] = e_group;
...
router.put('/:id', function(req, res) {
	...
	models.E_group.findOne({where: {id: id_e_group}}).then(function(e_group) {
		...
		// Update e_group
		e_group.update(updateObject, {where: {id: id_e_group}}, {user: req.user}).then(function() {
			answer["e_group".substring(2)] = e_group;
