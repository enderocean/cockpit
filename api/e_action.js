...
router.get('/:id', function(req, res) {
	...
	const id_e_action = parseInt(req.params.id);
...
router.get('/:id/:association', function(req, res) {
	...
	const id_e_action = req.params.id;
...
router.post('/', function(req, res) {
	...
	models.E_action.create(createObject, {user: req.user}).then(function(e_action) {
		answer["e_action".substring(2)] = e_action;
...
router.put('/:id', function(req, res) {
	...
	models.E_action.findOne({where: {id: id_e_action}}).then(function(e_action) {
		...
		// Update e_action
		e_action.update(updateObject, {where: {id: id_e_action}}, {user: req.user}).then(function() {
			answer["e_action".substring(2)] = e_action;
